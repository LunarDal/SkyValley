$(document).ready(function() {
    ...
    $('.club .c_tabs li a').click(function(e) {
        ...
        $('.club .c_tabs li').css('background-color', '');
        $('.club .c_tabs li').removeClass('on'); 
        targetLi.addClass('on');           
        

        targetLi.css('background-color', '#F2E3C2');
    ...
    $('.club .c_tabs li').on('mouseenter', function() {
        $(this).css('background-color', '#F2E3C2');
    }).on('mouseleave', function() {
        if (!$(this).hasClass('on')) {
            $(this).css('background-color', '#FFF5E2');
        }
    });
